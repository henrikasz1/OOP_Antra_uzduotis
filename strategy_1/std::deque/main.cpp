...
int main ()
{
  ...
  srand(time(0));
  deque<data> B;//vektorius, kuriame bus kiekvieno mokinio duomenys
  //-----
  ...
  deque<data> M; //i si vektoriu nuskaitys sugeneruota faila
  deque<data> protingi; //du vektoriai, skirti v1.0 versijai
  deque<data> kvaili; //+
 ...
 else if (read=='2')
 {
    ...
    for (int i=0; i<5; i++)//gali ramo neuztekt:D
    {
       ...
       distributeFile(numOfStudents, k, M, protingi, kvaili);
